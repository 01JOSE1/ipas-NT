pipeline {
        ...
        stage('Smoke Test on Docker') {
            steps {
                ...
                script {
                    ...
                    sh '''
                        for i in {1..20}; do
                            if docker exec ipas-jenkins curl -f http://ipas-app:8080/actuator/health; then
    ...
    post {
        success {
            ...
            echo '☸ Kubernetes (Production): ejecuta "minikube service ipas-service --url"'
